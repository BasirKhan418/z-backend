...
const TestQuestionSchema = new mongoose_1.default.Schema({
    testname: { type: mongoose_2.Schema.Types.String, ref: 'Test', default: '' },
    testid: { type: mongoose_2.Schema.Types.ObjectId, ref: 'Test', default: '' },
...
exports.default = mongoose_1.default.models['Testq'] || mongoose_1.default.model('Testq', TestQuestionSchema);
