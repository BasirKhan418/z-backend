...
router.post('/submit', async (req, res) => {
    try {
        ...
        try {
            ...
            let user = await User_1.default.findOneAndUpdate({ email: decoded.email }, { testResult: totalp, appeartest: true, testcorrect: `${totalcorrect}/${total}`, testid: testid, startdate: new Date() });
            if (user == null) {
